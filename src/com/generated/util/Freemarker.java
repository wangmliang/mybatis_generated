 ...
 * 生成代码模板操作类
 * <pre>
 * <b>Title：</b>Freemarker.java<br/>
 * <b>@author： </b>WML<br/>
 * <b>@date：</b>2016年10月25日 下午3:04:17<br/>  
...
public class Freemarker {
	...
	public static void printFile(String ftlName, Map<String,Object> root, String outFile, String filePath, String ftlPath) throws Exception{
		try {
		    /**
		     * relativelyPath：                                                    当前jar根目录
		     * filePath.replace("\\", "\\\\") 温文件保存目录
		     * outFile                        文件名
		     */
		    String relativelyPath = System.getProperty("user.dir");
			File file = new File(relativelyPath + "\\" + filePath.replace("\\", "\\\\") + outFile);
	 ...
	 * @throws Exception
	 * @author WML
	 * 2016年10月25日-下午2:41:37
	 */
	public static void printFileByObject(String ftlName, Object root, String outFile, String filePath, String ftlPath) throws Exception{
        try {
